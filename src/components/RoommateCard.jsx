...
const RoommateCard = ({ roommate }) => {
  const { _id, title, location, description, lifestylePreferences, roomType } = roommate;
      ...
      <div className="space-y-3">
        ...
        {lifestylePreferences && (
          <p className="text-md text-gray-600">
            <span className="font-medium text-gray-800">Lifestyle:</span> {lifestylePreferences}
          </p>
        )}
        ...
        <p className="text-md text-gray-700">
          <span className="font-medium text-gray-900">Room Type:</span> {roomType}
        </p>
      </div>
